	...
	<div class="max-w-7xl mx-auto px-4 py-4">
		<div class="flex flex-col md:flex-row justify-between mb-6">
			<div>
				...
				<div class="space-x-2">
					<a href="/qna"
						class="bg-black text-white text-xs px-3 py-1 rounded inline-block">Q&A</a>
					<a href="/contact"
						class="bg-black text-white text-xs px-3 py-1 rounded inline-block">1:1
						문의</a>
				</div>
			</div>
			<div
		...
		<div class="flex justify-end mt-6 space-x-2 opacity-60">
			<img src="${pageContext.request.contextPath}/image/footerImage.PNG"
				class="w-64 h-auto" alt="공정거래위원회">
		</div>
	</div>
</footer>
