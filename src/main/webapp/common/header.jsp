...
<body>
  ...
  <!-- ✅ 상단 바 -->
<div class="top-bar">
  <div class="logo"><a href="main">YOUSINSA</a></div>
  <div class="top-menu">
    <a href="#">쿠폰</a>
    <a href="#">공지사항</a>
    <a href="#">알림</a>
              ...
              <ul style="padding-left: 12px;">
                <c:forEach var="sub" items="${category.subCategoryList}">
                  <li style="list-style: none;">
                    <a href="/yousinsa/productList?categoryId=${category.categoryId}&subCategoryId=${sub.subCategoryId}"
