      ...
      <div class="content">
        ...
        <div class="container">
            <div class="left">
                ...
                <div class="sub-thumbnails">
                    <div class="sub-thumb" onclick="$('#mainImage2').click()"><span class="x" id="sub-thumb1-x">✖</span><img id="sub-thumb1" src='${contextPath}/image/maincloths.png'></div>
                    <div class="sub-thumb" onclick="$('#mainImage3').click()"><span class="x" id="sub-thumb2-x">✖</span><img id="sub-thumb2" src='${contextPath}/image/maincloths.png'></div>
                    <div class="sub-thumb" onclick="$('#mainImage4').click()"><span class="x" id="sub-thumb3-x">✖</span><img id="sub-thumb3" src='${contextPath}/image/maincloths.png'></div>
                </div>
        ...
        <div class="image-upload-section">
            <div class="big-preview-box" id="bigPreviewBox">
                <div class="big-img-slot" onclick="$('#imageDetail1').click()"><span class="x" id="image1-x">✖</span><img id="image1" src="${contextPath}/image/cloths.jpg"></div>
                <div class="big-img-slot" onclick="$('#imageDetail2').click()"><span class="x" id="image2-x">✖</span><img id="image2" src="${contextPath}/image/cloths.jpg"></div>
                <div class="big-img-slot" onclick="$('#imageDetail3').click()"><span class="x" id="image3-x">✖</span><img id="image3" src="${contextPath}/image/cloths.jpg"></div>
                <div class="big-img-slot" onclick="$('#imageDetail4').click()"><span class="x" id="image4-x">✖</span><img id="image4" src="${contextPath}/image/cloths.jpg"></div>
            </div>
